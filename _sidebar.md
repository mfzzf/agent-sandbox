...
* SDK 指南
    ...
    * 模板管理
        * [快速开始](/agent-sandbox/docs/sdk/template/01-quick-start.md)
        * [工作原理](/agent-sandbox/docs/sdk/template/02-how-it-works.md)
        * [用户与工作目录](/agent-sandbox/docs/sdk/template/03-user-and-work-dir.md)
        * [缓存机制](/agent-sandbox/docs/sdk/template/04-cache.md)
        * [基础镜像](/agent-sandbox/docs/sdk/template/05-base-image.md)
        * [私有仓库](/agent-sandbox/docs/sdk/template/06-private-registries.md)
        * [定义模板](/agent-sandbox/docs/sdk/template/07-defining-template.md)
        * [启动与就绪命令](/agent-sandbox/docs/sdk/template/08-start-and-ready-commands.md)
        * [构建模板](/agent-sandbox/docs/sdk/template/09-build.md)
        * [日志查看](/agent-sandbox/docs/sdk/template/10-logging.md)
    ...
    * 命令执行
        ...
        * [后台运行命令](/agent-sandbox/docs/sdk/commands/03-run-commands-in-background.md)
    * 文件系统
        * [概述](/agent-sandbox/docs/sdk/filesystem/01-overview.md)
        * [读写文件](/agent-sandbox/docs/sdk/filesystem/02-read-and-write.md)
        * [元数据信息](/agent-sandbox/docs/sdk/filesystem/03-file-and-directory-metadata.md)
